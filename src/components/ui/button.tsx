  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-2xl text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        outline:
          "border-0 bg-white/80 backdrop-blur-sm shadow-lg hover:shadow-xl hover:bg-white/90 text-slate-700 hover:text-slate-900",
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-secondary/80 shadow-lg hover:shadow-xl",
        ghost: "hover:bg-white/50 hover:text-accent-foreground rounded-xl",
        link: "text-primary underline-offset-4 hover:underline",
        login: "bg-black text-white hover:bg-gray-800 shadow-lg hover:shadow-xl focus:outline-none focus:ring-0 focus:border-0 active:outline-none active:ring-0 active:border-0",
      },
      size: {
